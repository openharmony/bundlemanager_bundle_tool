...
ErrCode BundleTestTool::CreateCommandMap()
{
    commandMap_ = {
        ...
        {"getAllBundleCacheStat", std::bind(&BundleTestTool::RunAsGetAllBundleCacheStat, this)},
        {"cleanAllBundleCache", std::bind(&BundleTestTool::RunAsCleanAllBundleCache, this)},

 ...
 * @tc.name: ExecCommand
 * @tc.desc: Verify the "bm install -v" command.
 */
HWTEST_F(BmCommandInstallTest, Bm_Command_Install_4600, Function | MediumTest | Level1)
{
    // install a bundle
    char *argv[] = {
        const_cast<char*>(TOOL_NAME.c_str()),
 ...
 * @tc.name: ExecCommand
 * @tc.desc: Verify the "bm install -v <signature-file-path>" command.
 */
HWTEST_F(BmCommandInstallTest, Bm_Command_Install_4700, Function | MediumTest | Level1)
{
    // install a bundle
    char *argv[] = {
        const_cast<char*>(TOOL_NAME.c_str()),
        const_cast<char*>(cmd_.c_str()),
        const_cast<char*>("-v"),
        const_cast<char*>(STRING_SIGNATURE_FILE_PATH.c_str()),
        const_cast<char*>(""),
    };
    int argc = sizeof(argv) / sizeof(argv[0]) - 1;
    ...
    EXPECT_EQ(cmd.ExecCommand(), HELP_MSG_NO_BUNDLE_PATH_OPTION + "\n" + HELP_MSG_INSTALL);
}

/**
 * @tc.number: Bm_Command_Install_4800
 * @tc.name: ExecCommand
 * @tc.desc: Verify the "bm install -p <bundle_path> -v <signature-file-path>" command.
 */
HWTEST_F(BmCommandInstallTest, Bm_Command_Install_4800, Function | MediumTest | Level1)
{
    // install a bundle
    char *argv[] = {
        const_cast<char*>(TOOL_NAME.c_str()),
 ...
 * @tc.desc: Verify the "bm install -p <bundle_path> -v <signature-file-path>" command.
 */
HWTEST_F(BmCommandInstallTest, Bm_Command_Install_4900, Function | MediumTest | Level1)
{
    // install a bundle
    char *argv[] = {
        const_cast<char*>(TOOL_NAME.c_str()),
        const_cast<char*>(cmd_.c_str()),
        const_cast<char*>("-p"),
        const_cast<char*>(STRING_TEST_BUNDLE_PATH.c_str()),
        const_cast<char*>("-v"),
        const_cast<char*>(STRING_SIGNATURE_FILE_PATH.c_str()),
        const_cast<char*>(""),
    };
 ...
 * @tc.name: ExecCommand
 * @tc.desc: Verify the "bm install -p <bundle_path> <bundle_path> -v <signature-file-path>" command.
 */
HWTEST_F(BmCommandInstallTest, Bm_Command_Install_5000, Function | MediumTest | Level1)
{
    // install a bundle
    char *argv[] = {
        const_cast<char*>(TOOL_NAME.c_str()),
    ...
    EXPECT_EQ(cmd.ExecCommand(), HELP_MSG_NOT_SUPPORT_MULTI_HAP_OR_HSP_INSTALLATION + HELP_MSG_INSTALL);
}

/**
 * @tc.number: Bm_Command_Install_5100
 * @tc.name: ExecCommand
 * @tc.desc: Verify the "bm install -p <bundle_path_dir> -v <signature-file-path>" command.
 */
HWTEST_F(BmCommandInstallTest, Bm_Command_Install_5100, Function | MediumTest | Level1)
{
    // install a bundle
    char *argv[] = {
        const_cast<char*>(TOOL_NAME.c_str()),
        const_cast<char*>(cmd_.c_str()),
        const_cast<char*>("-p"),
        const_cast<char*>(STRING_EMPTY.c_str()),
        const_cast<char*>("-v"),
        const_cast<char*>(STRING_SIGNATURE_FILE_PATH.c_str()),
        const_cast<char*>(""),
    };
